...
export const createAnnouncement = async (announcementData) => {
  try {
    const response = await api.post('/dashboard/announcements', announcementData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateAnnouncement = async (id, announcementData) => {
  try {
    const response = await api.put(`/dashboard/announcements/${id}`, announcementData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateVersion = async (versionData) => {
  try {
    const response = await api.post('/dashboard/version', versionData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const getVersionDescription = async () => {
  try {
    const response = await api.get('/dashboard/version/description');
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateVersionDescription = async (descriptionData) => {
  try {
    const response = await api.post('/dashboard/version/description', descriptionData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const getChampions = async () => {
  try {
    const response = await api.get('/dashboard/champions');
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const createChampion = async (championData) => {
  try {
    const response = await api.post('/dashboard/champions', championData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateChampion = async (id, championData) => {
  try {
    const response = await api.put(`/dashboard/champions/${id}`, championData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const deleteChampion = async (id) => {
  try {
    await api.delete(`/dashboard/champions/${id}`);
  } catch (error) {
    handleError(error);
  }
}; 