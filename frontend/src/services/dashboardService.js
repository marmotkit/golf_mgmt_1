...
export const createAnnouncement = async (announcementData) => {
  try {
    const response = await axios.post('/api/dashboard/announcements', announcementData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateAnnouncement = async (id, announcementData) => {
  try {
    const response = await axios.put(`/api/dashboard/announcements/${id}`, announcementData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateVersion = async (versionData) => {
  try {
    const response = await axios.post('/api/dashboard/version', versionData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const getVersionDescription = async () => {
  try {
    const response = await axios.get('/api/dashboard/version/description');
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateVersionDescription = async (descriptionData) => {
  try {
    const response = await axios.post('/api/dashboard/version/description', descriptionData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const getChampions = async () => {
  try {
    const response = await axios.get('/api/dashboard/champions');
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const createChampion = async (championData) => {
  try {
    const response = await axios.post('/api/dashboard/champions', championData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
...
export const updateChampion = async (id, championData) => {
  try {
    const response = await axios.put(`/api/dashboard/champions/${id}`, championData);
    return response.data;
  } catch (error) {
    handleError(error);
  }
